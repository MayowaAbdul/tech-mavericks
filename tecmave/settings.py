"""
Django settings for tecmave project.
...
SECRET_KEY = 'django-insecure--ke5(@32)rf+t*i8mr8&y2es2tv+x#g!_!g+o&8@sgrv8=@!=b'
...
WSGI_APPLICATION = 'tecmave.wsgi.application'
...
#             'propagate': True,
#         },
#         'fundraising': {  # Replace 'yourapp' with your actual app name
#             'handlers': ['console'],
#             'level': 'DEBUG',
#             'propagate': False,
#         },
